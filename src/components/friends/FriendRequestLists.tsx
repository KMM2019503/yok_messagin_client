...
const FriendRequestLists = () => {
  const { requestList, setRequestList } = useFriendStore();
  ...
  const fetchFriendRequestList = React.useCallback(async () => {
    setLoading(true);
    setError(null);
    try {
      ...
      <div className="overflow-y-visible">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <button
              onClick={fetchFriendRequestList}
          ...
          >
            <p className="text-primaryLight-700 dark:text-primaryDark-300 text-sm">
              {searchQuery
                ...
                : "Your friends request list is empty"}
            </p>
            {!searchQuery && (
              <button
                onClick={fetchFriendRequestList}
